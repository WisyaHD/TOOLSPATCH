...
function testConnection() {
    ...
    .then(data => {
        if (data.success) {
            ...
            statusDiv.innerHTML = '✅ Connected successfully! Available databases: ' + data.databases.join(', ');
        } else {
...
function saveConfig() {
    const config = {
        ...
        db_member: document.getElementById('db-member').value,
        db_jual: document.getElementById('db-jual').value,
        db_beli: document.getElementById('db-beli').value,
        collection_member: document.getElementById('collection-member').value,
        collection_jual: document.getElementById('collection-jual').value,
        collection_beli: document.getElementById('collection-beli').value,
        collection_hutang: document.getElementById('collection-hutang').value,
    ...
    fetch('/api/get-config')
        ...
        .then(data => {
            if (data.config) {
                ...
                document.getElementById('db-member').value = data.config.DB_MEMBER || 'db_hdpayn_asli';
                document.getElementById('db-jual').value = data.config.DB_JUAL || 'db_hdpayn_asli';
                document.getElementById('db-beli').value = data.config.DB_BELI || 'db_hdpayn_asli';
                document.getElementById('collection-member').value = data.config.COLLECTION_TT_MEMBER || 'tt_member';
                document.getElementById('collection-jual').value = data.config.COLLECTION_TT_JUAL_DETAIL || 'tt_jual_detail';
                document.getElementById('collection-beli').value = data.config.COLLECTION_TT_BELI_DETAIL || 'tt_beli_detail';
                document.getElementById('collection-hutang').value = data.config.COLLECTION_TT_HUTANG_DETAIL || 'tt_hutang_detail';
